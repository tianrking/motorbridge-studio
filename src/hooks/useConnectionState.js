...
export function useConnectionState({ pushLog, setStateSnapshot, onGatewayState }) {
  ...
  const bridge = useGatewayBridge({ wsUrl, channel, pushLog, setStateSnapshot, onGatewayState });
